...
class MasterQuery(BaseModel):
    queries: Dict[Literal["clinic", "research", "book"], str] = Field(
        description="Dictionary of {agent_type : query}. query will be passed to the vector store of respective agent_type"
    )
